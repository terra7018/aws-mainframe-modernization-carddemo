...
public record DailyTransaction(
    ...
    public Transaction asPosted(String processingTimestamp) {
        return new Transaction(id, typeCode, categoryCode, source, description, amount,
                merchantId, merchantName, merchantCity, merchantZip, cardNumber,
                originalTimestamp, processingTimestamp, filler);
    }
}
